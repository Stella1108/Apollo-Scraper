      ...
      >
        ...
        <div className="bg-gradient-to-br from-[#8b39ea] via-[#137fc8] to-[#1d4ed8] flex flex-col justify-center items-center text-white px-10 py-14 relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none opacity-30">
            ...
            <div className="absolute top-1/2 left-1/4 w-20 h-20 bg-white opacity-10 rounded-full blur-2xl"></div>
          </div>
          ...
          >
            ...
            <p className="mb-8 text-lg opacity-90">
              Enter your credentials to access your Globo Polo account and continue growing your business.
            </p>
