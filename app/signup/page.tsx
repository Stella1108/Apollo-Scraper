      ...
      >
        ...
        <div className="bg-gradient-to-br from-cyan-500 to-blue-700 flex flex-col justify-center items-center text-white px-10 py-14 relative">
          ...
          <p className="mb-8 text-lg">
            Enter your personal details and start your journey with Apollo Scraper.
          </p>
          <Link href="/login">
            <Button
              variant="outline"
              className="text-blue-400 border-white hover:bg-white hover:text-blue-700 font-semibold px-8 py-3 transition-all duration-200 rounded-full"
            >
              LOGIN
            </Button>
          </Link>
